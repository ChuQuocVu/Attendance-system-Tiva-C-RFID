...
#define LCD_DATA_4_0 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_4,0);
#define LCD_DATA_4_1 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_4,GPIO_PIN_4);

#define LCD_DATA_5_0 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_5,0);
#define LCD_DATA_5_1 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_5,GPIO_PIN_5);

#define LCD_DATA_6_0 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_6,0);
#define LCD_DATA_6_1 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_6,GPIO_PIN_6);
...
#define LINES_5X7   0x38  /* 5x7 characters, multiple line */
 ...
 /****************************************************************************
* Ham xay dung san de hien thi LCD
******************************************************************************/
...
void lcd_clear(void); // The function clear LCD's screen
void lcd_gotoxy(unsigned char col, unsigned char row); // The function points to the position to be displayed, where X is the position, Y is the line
void lcd_putc(char c); // Ham gui 1 ky tu len LCD
void lcd_puts(const char* s); // Ham gui 1 chuoi ki tu len LCD
